 ...
 */
public record ChunkFragmentM4sBuilderV3(int sequenceNumber) implements Mp4Builder {
  private static final Logger LOG = LoggerFactory.getLogger(ChunkFragmentM4sBuilderV3.class);
