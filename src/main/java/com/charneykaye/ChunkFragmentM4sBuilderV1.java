...
public class ChunkFragmentM4sBuilderV1 implements Mp4Builder {
    ...
    public ChunkFragmentM4sBuilderV1(
            int sampleRate,
            int lengthSeconds,
            long sequenceNumber
    ) {
    ...
    int[] getChunkSizes(Track track) {
        ...
        assert ChunkFragmentM4sBuilderV1.this.track2Sample.get(track).size() == sum(chunkSizes) : "The number of samples and the sum of all chunk lengths must be equal";
        return chunkSizes;
    }
