...
public class ChunkFragmentM4SBuilderV3Test extends TestBase {
  private static final Logger LOG = LoggerFactory.getLogger(ChunkFragmentM4SBuilderV3Test.class);
  ...
  private ChunkFragmentM4sBuilderV3 subject;

  public ChunkFragmentM4SBuilderV3Test(
  ) {
  ...
  public void setUp() {
    ...
    subject = new ChunkFragmentM4sBuilderV3(sequenceNumber);
  }
