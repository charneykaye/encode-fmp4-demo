...
public class ChunkFragmentM4SBuilderV2Test extends TestBase {
  private static final Logger LOG = LoggerFactory.getLogger(ChunkFragmentM4SBuilderV2Test.class);
  ...
  private ChunkFragmentM4sBuilderV2 subject;

  public ChunkFragmentM4SBuilderV2Test(
  ) {
  ...
  public void setUp() {
    ...
    subject = new ChunkFragmentM4sBuilderV2(sequenceNumber);
  }
